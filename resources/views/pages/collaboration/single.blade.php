        ...
        <div class="row">
            <div class="col-md-8">
                ...
                <div class="post fl-wrap fw-post">
                    <h2><a href="{{route('pages.collaboration.single',['id'=>$collaboration->id])}}"><span>{{strtoupper( $collaboration->title)}}</span></a></h2>
                    <div class="parallax-header"><a href="#">{{$collaboration->updated_at->formatLocalized('%D')}}</a></div>
                    <!-- blog media -->
                    <div class="blog-media fl-wrap nomar-bottom">
                        <div class="single-slider-wrap slider-carousel-wrap ">
                            <div class="single-slider cur_carousel-slider-container fl-wrap">
                                <div class="slick-slide-item"><img src="{{asset( $collaboration->image)}} " alt=""></div>
                            </div>
