...
@section('content')
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">İş Birlikleri</h4>
        ...
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Yeni İşbirliği Ekle</h5>
                    ...
                    <div class="form-control mt-5">
                        <div class="mb-10 mt-10">
                            ...
                            <input type="text" name="create_title" class="form-control form-control-solid"
                                   placeholder="İşbirliği ile ilgili başlık "/>
                        </div>
                        <div class="mb-10 mt-10">
                            ...
                            <input type="text" name="create_description" class="form-control form-control-solid"
                                   placeholder="İşbirliği ile ilgili kısa açıklama"/>
                        </div>
                        <div class="mb-10 mt-10">
    ...
    <div class="modal fade" tabindex="-1" id="kt_modal_2">
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">İşbirliği Düzenle</h5>
    ...
    <script>
        $('#create_news').click(function () {
            ...
            $.ajax({
                ...
                type: 'POST',
                url: '{{route('admin.pages.collaboration-create')}}',
                data: {title: title, content: content, image: image, description: description},
                dataType: 'json',
                success: function (data) {
                    if(data.status == 'success') {

                        toastr.success('İşbirliği başarıyla oluşturuldu');
                        $('#kt_modal_1').modal('hide');
                        location.reload();
                    }
                    else {
                        toastr.error('İşbirliği oluşturulurken bir hata oluştu');
                    }
                }
            });
        });
    ...
    <script>
        ...
        $('#update_news').click(function () {
            ...
            $.ajax({
                ...
                type: 'POST',
                url: '{{route('admin.pages.collaboration-update')}}',
                data: {title: title, content: content, image: image, description: description, id: id},
                dataType: 'json',
                success: function (data) {
                    if(data.status == 'success') {

                        toastr.success('İşbirliği başarıyla güncellendi');
                        $('#kt_modal_2').modal('hide');
                        location.reload();
                    }
                    else {
                        toastr.error('İşbirliği güncellenirken bir hata oluştu');
                    }
                }
            });
        });
            ...
            swal.fire({
                ...
                if (result.value) {
                    $.ajax({
                        ...
                        type: 'POST',
                        url: '{{route('admin.pages.collaboration-delete')}}',
                        data: {id: id},
                        dataType: 'json',
                        success: function (data) {
                            if(data.status == 'success') {

                                toastr.success('İşbirliği başarıyla silindi');
                                location.reload();
                            }
                            else {
                                toastr.error('İşbirliği silinirken bir hata oluştu');
                            }
                        }
                    });
                }
