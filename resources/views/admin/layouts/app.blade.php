                            ...
                            <div class="menu-item">
                                <a class="menu-link {{request()->routeIs('admin.pages.setting') ? "active" : ""}}"
                                   href="{{route('admin.pages.setting')}}">
                                    ...
                                    <span class="menu-title">Sabit Sayfa Ayarları</span>
                                </a>
                            </div>

                            <div class="menu-item">
                                <a class="menu-link {{request()->routeIs('admin.pages.dynamic') ? "active" : ""}}"
                                   href="{{route('admin.pages.dynamic')}}">
										<span class="menu-icon">
											<!--begin::Svg Icon | path: icons/duotune/general/gen014.svg-->
											<span class="svg-icon svg-icon-2">
										<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <span class="menu-title">Dinamik Sayfa Ayarları</span>
                                </a>
                            </div>
